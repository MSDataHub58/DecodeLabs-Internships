...
Trend Analysis
Product-Level Outlier Analysis
Interactive filters
A separate Insights page connected through page navigation
Project Workflow

Raw Data → Data Cleaning → Statistical Analysis → Outlier Detection → Visualization → Insights → Dashboard
